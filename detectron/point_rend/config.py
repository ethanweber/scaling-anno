...
def add_pointrend_config(cfg):
    ...
    cfg.MODEL.POINT_HEAD.NUM_HEADS = 1
    ...
    cfg.TEST.DIVERSITY = CN()
    # If True, use highest predicted IOU. If False, use best IOU.
    cfg.TEST.DIVERSITY.PRED_IOU = True
    # If True, then export inference to a COCO formatted file.
    cfg.TEST.DIVERSITY.EXPORT = False
    cfg.TEST.BATCH_SIZE = 1

    # Removing small objects.
    cfg.MODEL.PROPOSAL_GENERATOR.TEST_MIN_SIZE = 30
    cfg.MODEL.ROI_HEADS.SCORE_THRESH_TEST = 0.2 # was 0.05
